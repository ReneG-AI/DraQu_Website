    ...
    <main className="pt-24 pb-16 px-6">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none text-muted-foreground space-y-6">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">{t('guidelinesRules')}</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">{t('guidelinesViolations')}</h2>
