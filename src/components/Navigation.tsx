...
const Navigation = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border/50">
      <div className="container mx-auto px-6 py-2.5 md:py-3">
        <div className="flex items-center justify-between gap-2 md:hidden">
          <Button
            ...
            asChild
          >
            <a href={steamUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2" aria-label={t('ctaWishlist')}>
              ...
              <span className="hidden sm:inline">{t('ctaWishlist')}</span>
            </a>
          </Button>
          ...
          <div className="flex items-center gap-2">
            ...
            <Sheet>
              ...
              <SheetContent className="bg-background/95 backdrop-blur-md border-border/70">
                <SheetHeader>
                  <SheetTitle>Menu</SheetTitle>
                </SheetHeader>
                <div className="mt-6 flex flex-col gap-3">
                  <SheetClose asChild>
                    <Button variant="ghost" className="justify-start text-foreground hover:text-primary transition-colors" asChild>
                      <Link to="/" onClick={handleHomeClick}>{t('navHome')}</Link>
                    </Button>
                  </SheetClose>
                  <SheetClose asChild>
                    <Button variant="ghost" className="justify-start text-foreground hover:text-primary transition-colors" asChild>
                      <Link to="/#nexus">{t('navNexus')}</Link>
                    </Button>
                  </SheetClose>
                  <SheetClose asChild>
                    <Button variant="ghost" className="justify-start text-foreground hover:text-primary transition-colors" asChild>
                      <Link to="/roadmap">{t('navRoadmap')}</Link>
                    </Button>
                  </SheetClose>
                  <SheetClose asChild>
                    <Button variant="ghost" className="justify-start text-foreground hover:text-primary transition-colors" asChild>
