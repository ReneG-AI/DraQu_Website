    ...
    <footer className="bg-card border-t border-border/50 py-12">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-muted-foreground mb-4 max-w-md">
              Awakening of the Elements - A cooperative card game where dragons and magic await your discovery.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-muted-foreground">
              ...
              <li><a href="#" className="hover:text-primary transition-colors">Release Date</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">Steam Page</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-border/50 mt-8 pt-8 text-center text-muted-foreground">
          <p>&copy; 2024 DraQu: Awakening of the Elements. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
