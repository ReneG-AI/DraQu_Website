...
const DiscordSection = () => {
  ...
  return (
    <section id="community" className="py-20 bg-gradient-to-r from-background via-primary/5 to-background">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button 
              ...
              onClick={() => window.open('https://discord.gg/YNyBnuBVWG', '_blank', 'noopener,noreferrer')}
            >
              <svg 
